...
<script>
  ...
  export default {
    ...
    methods: {
      getSaleView() {
        this.saleData = { "leadsNum": 61, "leadsNumYoY": "--", "leadsNumMoM": "103.3%", "followUpRate": "3.3%", "validLeadsRate": "100.0%", "customerNum": 61, "customerNumYoY": "--", "customerNumMoM": "103.3%", "thirtyMinutesFollowUpRate": "1.6%", "validToStoreRate": "36.1%", "toStoreNum": 22, "toStoreNumYoY": "--", "toStoreNumMoM": "57.1%", "toStoreRate": "36.1%", "validTestDriveRate": "0.0%", "testDriveNum": 0, "testDriveNumYoY": "--", "testDriveNumMoM": "--", "testDriveRate": "0.0%", "validOrderRate": "60.7%", "orderNum": 37, "orderNumYoY": "--", "orderNumMoM": "1750.0%", "orderRate": "60.7%", "validBargainRate": "13.1%", "bargainNum": 8, "bargainNumYoY": "--", "bargainNumMoM": "-11.1%", "bargainRate": "13.1%", "updateTime": "2023-03-29 14:35:04", "firstCallTaskNum": 2, "thirtyMinutesFirstCallTaskNum": 1 }
        this.initChart()
      },
      changeField(val) {
